...
# Package meta-data.
NAME = 'alifexnet'
DESCRIPTION = 'AlexNet, but with leaky-integrate-and-fire (LIF) neurons'
URL = 'https://github.com/NickleDave/ALIFexNet'
...
REQUIRED = [
    'nengo', 'nengo_dl>=2.1.1', 'tensorflow>=1.13.1', 'numpy',
]
